                ...
                <div className="flex-1 flex flex-col bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
                    ...
                    <div className="overflow-y-auto custom-scrollbar flex-1">
                        ...
                        <div className="grid grid-cols-12 gap-4 px-4 py-4 border-b border-slate-100 dark:border-slate-700/50 hover:bg-slate-50 dark:hover:bg-slate-700/50 items-center transition-colors group">
                            ...
                            <div className="col-span-2 flex items-center gap-2">
                                <div className="size-6 rounded-full bg-emerald-100 dark:bg-emerald-900/50 text-emerald-600 dark:text-emerald-300 flex items-center justify-center text-xs font-bold">AS</div>
                        ...
                        <div className="grid grid-cols-12 gap-4 px-4 py-4 border-b border-slate-100 dark:border-slate-700/50 hover:bg-slate-50 dark:hover:bg-slate-700/50 items-center transition-colors group">
                            ...
                            <div className="col-span-1">
                                <span className="bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 px-2 py-1 rounded text-xs font-bold">Low</span>
                            </div>
                            <div className="col-span-2">
                                <div className="flex flex-col">
                                    <span className="text-sm font-medium text-slate-900 dark:text-white">HVAC Unit 3</span>
                                    <span className="text-xs text-slate-500">Admin Building</span>
                                </div>
                            </div>
                            <div className="col-span-3">
                                <div className="text-sm text-slate-700 dark:text-slate-300 line-clamp-2">
                                    <span className="font-semibold">Fan:</span> Periodic maintenance request (Filter check).
                                </div>
                            </div>
                            <div className="col-span-2 flex items-center gap-2">
                                <div className="size-6 rounded-full bg-purple-100 dark:bg-purple-900/50 text-purple-600 dark:text-purple-300 flex items-center justify-center text-xs font-bold">MK</div>
                                <span className="text-sm text-slate-700 dark:text-slate-300">Mike K.</span>
                            </div>
                            <div className="col-span-1">
                                <div className="flex items-center gap-1.5">
                                    <span className="size-2 rounded-full bg-green-500"></span>
                        ...
                        <div className="grid grid-cols-12 gap-4 px-4 py-4 border-b border-slate-100 dark:border-slate-700/50 hover:bg-slate-50 dark:hover:bg-slate-700/50 items-center transition-colors group">
                            ...
                            <div className="col-span-2">
                                <div className="flex flex-col">
                                    <span className="text-sm font-medium text-slate-900 dark:text-white">Robot Arm Kuka-7</span>
                                    <span className="text-xs text-slate-500">Zone B - Assembly</span>
                                </div>
                            </div>
                            <div className="col-span-3">
                                <div className="text-sm text-slate-700 dark:text-slate-300 line-clamp-2">
                                    <span className="font-semibold">Servo:</span> Axis 3 positioning error exceeded tolerance.
                                </div>
                            </div>
                            <div className="col-span-2 flex items-center gap-2">
                                <div className="size-6 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400 flex items-center justify-center text-xs font-bold">--</div>
